...
# @Time : 2026-03-30
# @Author : wenchao
# @Desc : 任务评估指标计算脚本（ER + ER-soft + softOHR + Real_ER + All_ER）
...
# ==================== 路径配置 ====================
BASE_DATA_DIR = "../../data_final_real/test/hug"
# BASE_DATA_DIR = "../../datav1/test/daily"

# INPUT_TEST_TASK = os.path.join(BASE_DATA_DIR, "stage4_result_only_task_DEP2.json")

# INPUT_TEST_TASK = os.path.join(BASE_DATA_DIR, "gnn1_rgcn_best_ALLfirst.json")
INPUT_TEST_TASK = os.path.join(BASE_DATA_DIR, "gnn1_rgcn_best.json")
